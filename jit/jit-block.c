...
/*@
 * @deftypefun void jit_block_set_label_name (jit_block_t @var{block}, const char* @var{name})
 * Associates a name to the label of this block
 * @end deftypefun
@*/
void jit_block_set_label_name(jit_block_t block, const char *name) {
    block->name = jit_strdup(name);
}
